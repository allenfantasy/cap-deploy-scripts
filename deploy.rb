...
set :application, "rails_template" # NOTICE! CHANGE ME WITH APPLICATION NAME!
set :user, "deployer"
set :deploy_to, "/home/#{user}/apps/#{application}"
set :deploy_via, :remote_cache
set :use_sudo, false
set :nginx_port, 81 # default port for nginx is 80. CHANGE THIS IF NEEDED

set :scm, :git
set :repository,  "git@github.com:allenfantasy/rails-template.git" # NOTICE! CHANGE ME WITH REPO URL!
set :branch, "master"
